...
ActiveRecord::Schema.define(version: 2019_11_24_142008) do
  ...
  create_table "animal_encontrados", force: :cascade do |t|
    t.string "specie"
    t.string "sex"
    t.date "founddate"
    t.string "foundplace"
  ...
  create_table "animal_perdidos", force: :cascade do |t|
    t.string "specie"
    t.string "sex"
    t.date "founddate"
    t.string "foundplace"
